...
class Easing {
	...
	static inline public function bounce(v:Float):Float {
		v = 1 - v;
		return 1
			- if (v < (1 / 2.75)) (7.5625 * v * v) else if (v < (2 / 2.75)) (7.5625 * (v -= (1.5 / 2.75)) * v + .75) else if (v < (2.5 / 2.75))
				(7.5625 * (v -= (2.25 / 2.75)) * v
				+ .9375) else (7.5625 * (v -= (2.625 / 2.75)) * v + .984375);
	}
