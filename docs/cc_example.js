...
var Main = function() {
	...
	window.document.addEventListener("DOMContentLoaded",function(event) {
		$global.console.info("" + sketcher_App.NAME + " Main Dom ready :: build: " + "2020-09-27 10:15:33");
...
Sketcher.prototype = {
	appendTo: function(element) {
		...
		case "webgl":
			...
			break;
		default:
			console.log("src/Sketcher.hx:118:","case '" + this.settings.get_type().toLowerCase() + "': trace ('" + this.settings.get_type().toLowerCase() + "');");
		}
		return this;
	}
	...
	,update: function() {
		...
		case "svg":
			...
			break;
		case "webgl":
			console.log("src/Sketcher.hx:642:","webgl");
			var _g = 0;
			var _g1 = this.baseArray.length;
			while(_g < _g1) {
				var i = _g++;
			...
			break;
		default:
			console.log("src/Sketcher.hx:651:","case '" + this.settings.get_type() + "': trace ('" + this.settings.get_type() + "');");
		}
		this.baseArray = [];
	}
	,__class__: Sketcher
...
examples_ExAll.prototype = {
	...
	,generateShapes: function(sketch) {
		...
		circle.set_strokeColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.LIME));
...
examples_ExBackground.prototype = {
	...
	,generateShapes: function(sketch) {
		...
		var p = this.grid.array[1];
		var c = sketch.makeCircle(p.x,p.y,50).setFill(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.MAROON));
...
examples_ExCircles.prototype = {
	...
	,generateShapes: function(sketch) {
		...
		var p = this.grid.array[1];
		var circle = sketch.makeCircle(p.x,p.y,this.radiusSmall);
		circle.set_fillColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.LIME));
		var p = this.grid.array[2];
		var circle = sketch.makeCircle(p.x,p.y,this.radiusSmall);
		circle.set_fillColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.LIME));
		...
		var circle = sketch.makeCircle(p.x,p.y,this.radiusSmall);
		circle.set_lineWeight(10);
		circle.set_fillColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.PINK));
		...
		circle.set_fillColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.PINK));
		circle.set_fillOpacity(0.5);
		circle.set_strokeColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.GREEN));
		var p = this.grid.array[5];
		var circle = sketch.makeCircle(p.x,p.y,this.radiusSmall);
		circle.set_lineWeight(10);
		circle.set_fillColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.PINK));
		...
		circle.set_fillColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.PINK));
		circle.set_fillOpacity(0);
		circle.set_strokeColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.FUCHSIA));
...
examples_ExGroup.prototype = {
	...
	,generateShapes: function(sketch) {
		...
		g.set_fillColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.RED));
		g.set_strokeColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.BLUE));
		...
		g.noFill();
		g.setStroke(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.PURPLE),10,.3);
		g.setRotate(45,p.x,p.y);
		var p = this.grid.array[4];
		var shape = sketch.makeCircle(p.x,p.y,this.radiusSmall);
		var shape2 = sketch.makeCircle(p.x + this.radiusSmall,p.y,this.radiusSmall / 2);
		var shape3 = sketch.makeRectangle(p.x - this.radiusSmall,p.y,this.radiusSmall,this.radiusSmall);
		shape3.setFill(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.WHITE));
		var g = sketch.makeGroup([shape,shape2,shape3]);
		g.set_id("group purple shape norotated");
		g.noFill();
		g.setStroke(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.MAROON),10,.3);
		sketch.update();
	}
...
examples_ExLine.prototype = {
	...
	,generateShapes: function(sketch) {
		...
		line.set_strokeWeight(10);
		line.set_lineCap("round");
		line.set_strokeColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.GREEN));
		var p = this.grid.array[2];
		var line = sketch.makeLine(p.x,p.y,p.x + this.radiusSmall,p.y + this.radiusSmall);
		line.set_strokeWeight(10);
		line.set_lineCap("round");
		...
		line.set_strokeWeight(10);
		line.set_lineCap("round");
		line.set_strokeColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.PINK));
...
examples_ExMask.prototype = {
	...
	,generateShapes: function(sketch) {
		...
		mask.set_id("mask-4");
		var circle = sketch.makeCircle(p.x,p.y,50);
		circle.setFill(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.ORANGE));
...
examples_ExPolygon.prototype = {
	...
	,generateShapes: function(sketch) {
		...
		_polygon.setStroke(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.PINK),10);
		_polygon.setFill(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.LIME));
		var p = this.grid.array[2];
		var _polygon = sketch.makePolygon([]);
		...
		_polygon.setStroke(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.PURPLE),25);
		_polygon.noFill();
		_polygon.set_lineJoin("round");
		var p = this.grid.array[7];
		var _polygon = sketch.makePolygon([]);
		_polygon.sides(p.x,p.y,5,this.radiusSmall);
		_polygon.setStroke(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.RED),20);
		_polygon.noFill();
		_polygon.setLineEnds();
		var p = this.grid.array[8];
		var _polygon = sketch.makePolygon([p.x - 50,p.y + 40,p.x + 30,p.y - 50,p.x + 50,p.y + 20]);
		_polygon.setStroke(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.GRAY),20);
		_polygon.setFill("#33C4B8");
		_polygon.setLineEnds();
		sketch.update();
	}
...
examples_ExPolyline.prototype = {
	...
	,generateShapes: function(sketch) {
		...
		var p = this.grid.array[1];
		var shape = sketch.makePolyLine(this.getSides(p));
		shape.set_strokeColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.GREEN));
		var p = this.grid.array[2];
		var shape = sketch.makePolyLine(this.getSides(p));
		shape.set_fillColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.PINK_HOT));
		shape.set_strokeColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.GREEN));
		var p = this.grid.array[3];
		var shape = sketch.makePolyLine(this.getSides(p));
		shape.set_fillColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.PINK_HOT));
		...
		shape.set_strokeColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.MAROON));
		shape.set_strokeWeight(10);
		shape.set_lineCap("round");
		var p = this.grid.array[7];
		var shape = sketch.makePolyLine(this.getSides(p));
		shape.set_fillOpacity(0);
		shape.set_strokeColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.LIME));
		shape.set_strokeWeight(10);
		shape.set_lineCap("round");
		...
		shape.setFill(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.PINK_DEEP)).setStroke(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.PINK_DEEP),10);
...
examples_ExRectangle.prototype = {
	...
	,generateShapes: function(sketch) {
		...
		shape.set_fillColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.LIME));
		...
		var shape = sketch.makeRectangle(p.x,p.y,this.rectW,this.rectH);
		shape.set_lineWeight(10);
		shape.set_fillColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.PINK));
		...
		shape.set_fillColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.PINK));
		shape.set_fillOpacity(0);
		shape.set_strokeColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.FUCHSIA));
		var p = this.grid.array[7];
		var shape = sketch.makeRectangle(p.x,p.y,this.rectW,this.rectH);
		shape.set_lineWeight(10);
		shape.set_fillOpacity(0);
...
examples_ExText.prototype = {
	...
	,generateShapes: function(sketch) {
		...
		shape.set_fillColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.PINK_DEEP));
		var p = this.grid.array[0];
		var shape = sketch.makeText("Test (24px)",p.x,p.y);
		shape.set_fillColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.GREEN));
		...
		shape.set_fillColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.OLIVE));
		...
		shape.set_fillColor(sketcher_util_ColorUtil.getColourObj(sketcher_util_ColorUtil.BLACK));
		var p = this.grid.array[10];
...
sketcher_draw_Base.prototype = {
	...
	,clone: function() {
		console.log("src/sketcher/draw/Base.hx:262:","WIP");
...
sketcher_draw_Polygon.prototype = $extend(sketcher_draw_Base.prototype,{
	...
	,getPoint: function(id) {
		if(id * 2 > this.get_arr().length) {
			console.log("src/sketcher/draw/Polygon.hx:139:","not in this length");
		}
...
sketcher_util_MathUtil.pythagoreanTheorem = function(a,b,c) {
	if(a == null && b == null && c == null) {
		console.log("src/sketcher/util/MathUtil.hx:110:","Really? Perhaps you should use some data");
		return 0;
	}
	var value = 0.0;
	if(c == null || c == 0) {
