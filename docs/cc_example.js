...
var Main = function() {
	...
	window.document.addEventListener("DOMContentLoaded",function(event) {
		$global.console.info("" + sketcher_App.NAME + " Main Dom ready :: build: " + "2023-09-26 20:59:32");
...
sketcher_draw_Text.prototype = $extend(sketcher_draw_Base.prototype,{
	...
	,ctx: function(ctx) {
		...
		if(this.get_fitWidth() != 0) {
			...
			lines.push(sentance);
			haxe_Log.trace(sentance,{ fileName : "src/sketcher/draw/Text.hx", lineNumber : 237, className : "sketcher.draw.Text", methodName : "ctx"});
		} else {
